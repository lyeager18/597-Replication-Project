...
after ban is lifted" variables are binary response indicators based on the 
following scale for whether the respondent would be likely to drive once the ban 
on female driving would be lifted (it was lifted partway through the baseline): 
unlikely to drive, somewhat likely, likely but not at first, and likely. Responders 
include 501 RCT participants who started the endline survey. To estimate the F-stat, 
we impute variable means for missing values.
********************************************************************************
********************************************************************************
*******************************************************************************/
eststo clear
