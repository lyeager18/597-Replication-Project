...
* Set global for table outcomes
	global genpol gen_policy_binary_sw P1_2_abovemed
...
* Run models
		...
		* (1) Cohort FEs, PAP controls
			...
			/* (2) "Society moving fast enough" - this qn was modified part way through
				...
				reghdfe P1_1_abovemed treatment question_timing $controls, ///
					absorb(randomization_cohort2) vce(cluster file_nbr)
					eststo P1_1_abovemed

				* grab control mean
				sum P1_1_abovemed if e(sample) & treatment==0
				estadd scalar cmean = r(mean)	
