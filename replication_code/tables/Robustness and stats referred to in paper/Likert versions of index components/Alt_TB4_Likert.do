...
Purpose: 	Robustness	-	Alternate Table B4; Ability to leave the house, 
							Ability to make purchases; multiple hypothesis testing



Table footnotes: Alternate version of Table B4, where we use the full likert 
scale to generate the index outcome. Outcomes were constructed as follows: respondents were asked to 
...
* Set global for table outcomes
	...
	* likert/cts version
	global 	mob_spen  G1_2_likert G1_3_likert 
...
* Run models	
		*  Run first for q-vals: Cohort FEs, PAP controls, baseline employment
		...
		preserve
		mat pval = (`p_G1_2_likert' \ `p_G1_3_likert')
...
* Write to latex
	...
	"$output_rct/robustness/Alt_Table_B4_Likert.tex", ///
