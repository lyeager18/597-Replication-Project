...
Purpose: 	Robustness	-	Alternate Table B6, Panel A; Ability to leave the 
							house, Ability to make purchases; multiple hypothesis 
							testing; HTE (Has husband/co-parent); Likert version
								  
								  
TABLE FOOTNOTES: Alternate version of Table B6, Panel A, where we use the full likert 
...
each, except for the interaction control. As such, Ns are lower relative to Table 
1. Four respondents are missing values for marital status (and therefore missing 
values for whether they have a husband or co-parent), and one respondent is missing 
a value for labor force participation at baseline. * p < 0.1 ** p < 0.05 *** p < 0.01.							 
********************************************************************************
********************************************************************************
*******************************************************************************/
eststo clear
...
* Run models
		...
		* Run and store p-vals for FDR
		...
		mat pval_b1 = (`p_G1_2_likert_b1' \ `p_G1_3_likert_b1')
		mat pval_b13 = (`p_G1_2_likert_b13' \ `p_G1_3_likert_b13')
		...
		* (3) RE-RUN  MODELS FOR HAS HUSBAND/CO-PAR - STORE ESTIMATES
...
* ALT TABLE B6
	...
	* PANEL A - Has husband/co-parent		 
	esttab G1_2_likert_inf  G1_3_likert_inf using ///
		"$output_rct/robustness/Alt_Table_B6_Panel_A_Likert.tex", ///
